    ...
    case "Personal":
      return (
        <svg
          ...
          stroke={strokeColor}
        >
          <circle cx="32" cy="18.14" r="11.14" strokeWidth="6"
            strokeLinecap="round"
            strokeLinejoin="round"/>
          <path d="M54.55,56.85A22.55,22.55,0,0,0,32,34.3h0A22.55,22.55,0,0,0,9.45,56.85Z" strokeWidth="6"
            strokeLinecap="round"
            strokeLinejoin="round"/>
        </svg>
      );
    ...
    case "Additional":
      return (
        <svg
          ...
          viewBox="0 0 1024 1024"
          xmlns="http://www.w3.org/2000/svg"
          className="additional-icon icon"
        >
